...
<head>
  ...
  <title>Incubator of Biskra</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Enseignant </span>
      </a>
    ...
    <nav class="header-nav ms-auto">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-5" href="#" data-bs-toggle="dropdown">
			...
			<?php  $queryy = "SELECT firstnamefr, lastnamefr FROM enseignant WHERE username = '$username'";
    ...
    if($result) {
        ...
        $nom=$row['firstnamefr']."<br>".$row['lastnamefr']; 
  ...
  <footer id="footer" class="footer">
     <center>© Copyright UMKB Digitization Project © ILHEM ALLAOUI ©2024
